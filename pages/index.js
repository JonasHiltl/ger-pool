        ...
        <AccordionItem>
            ...
            <AccordionPanel>
              ...
              <Wrap w="100%" my="30px" justify={[ "space-evenly", "space-evenly"]} shouldWrapChildren="true" spacing="20px">
                <Image src="screen1.PNG" width={["120px", "150px", "180px"]} height="auto" mx="10px"/>
                <Image src="screen2.PNG" width={["120px", "150px", "180px"]} height="auto" mx="10px"/>
                <Image src="screen3.PNG" width={["120px", "150px", "180px"]} height="auto" mx="10px"/>
                <Image src="screen4.PNG" width={["120px", "150px", "180px"]} height="auto" mx="10px"/>
              </Wrap>
